...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("• ʜᴀɴᴅʟᴇʀ •", callback_data="daxx_back")
        ]]
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/allanime_moviehindi"),    
        ]
        ]
